...
from tgbot.handlers.cities_handler import register_cities_menu
from tgbot.handlers.exo import register_echo
from tgbot.handlers.menu import register_menu
from tgbot.handlers.retsep import register_retsept
